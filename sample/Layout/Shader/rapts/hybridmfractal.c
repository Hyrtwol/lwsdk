 ...
 */
XCALL_(int)
HybridMFractalActivate (int version, GlobalFunc *global, LWTextureHandler *local,
  void *serverData)
{
 ...
 */
void *
HM_view_get ( HybridMFractal *inst, unsigned int vid ) 
{
  void *result = NULL;
 ...
 */
int
HM_view_set ( HybridMFractal *inst, unsigned int vid, void *value )
{
  int result = 0;
 ...
 */
int
HybridMFractalInterface (int version, GlobalFunc *global, LWInterface *iface,
  void *serverdata )
{
  int rc = AFUNC_OK;
