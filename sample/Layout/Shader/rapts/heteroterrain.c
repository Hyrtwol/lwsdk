 ...
 */
XCALL_(int)
HeteroTerrainActivate (int version, GlobalFunc *global, LWTextureHandler *local,
  void *serverData)
{
 ...
 */
void *
HT_view_get ( HeteroTerrain *inst, unsigned int vid ) 
{
  void *result = NULL;
 ...
 */
int
HT_view_set ( HeteroTerrain *inst, unsigned int vid, void *value )
{
  int result = 0;
 ...
 */
int
HeteroTerrainInterface (int version, GlobalFunc *global, LWInterface *iface,
  void *serverdata )
{
  int rc = AFUNC_OK;
