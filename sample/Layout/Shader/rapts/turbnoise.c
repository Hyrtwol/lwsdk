 ...
 */
XCALL_(int)
TurbNoiseActivate (int version, GlobalFunc *global, LWTextureHandler *local,
  void *serverData)
{
 ...
 */
void *
TN_view_get ( TurbNoise *inst, unsigned int vid ) 
{
  void *result = NULL;
 ...
 */
int
TN_view_set ( TurbNoise *inst, unsigned int vid, void *value )
{
  int result = 0;
 ...
 */
int
TurbNoiseInterface (int version, GlobalFunc *global, LWInterface *iface,
  void *serverdata )
{
  int rc = AFUNC_OK;
