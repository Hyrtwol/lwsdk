 ...
 */
XCALL_(int)
MultiFractalActivate (int version, GlobalFunc *global, LWTextureHandler *local,
  void *serverData)
{
 ...
 */
void *
MF_view_get ( MultiFractal *inst, unsigned int vid ) 
{
  void *result = NULL;
 ...
 */
int
MF_view_set ( MultiFractal *inst, unsigned int vid, void *value )
{
  int result = 0;
 ...
 */
int
MultiFractalInterface (int version, GlobalFunc *global, LWInterface *iface,
  void *serverdata )
{
  int rc = AFUNC_OK;
