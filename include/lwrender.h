...
#define LWITEMINFO_GLOBAL	"LW Item Info 5"
...
typedef struct st_LWObjectInfo {
    ...
    void (*bounds)( LWItemID objectitem, LWDVector min, LWDVector max );
...
#define LWCAMERAINFO_GLOBAL	"LW Camera Info 5"
...
typedef struct st_LWCameraInfo {
    ...
    void		(*maskLimits)	 (LWItemID, int *out_x0, int *out_y0, int *out_x1, int *out_y1);
...
#define LWVIEWPORTINFO_GLOBAL	"LW Viewport Info 4"
